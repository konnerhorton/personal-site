...
Recently I [decided to figure out](/posts/using-a-llm-to-read-documents/) how I can use a [large language model](https://en.wikipedia.org/wiki/Large_language_model) to read engineering and construction documents.
